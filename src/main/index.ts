...
function createWindow(): void {
    ...
    const mainWindow = new BrowserWindow({
        ...
        webPreferences: {
            ...
            sandbox: true,
            webSecurity: true, // This should generally be true for security reasons
...
app.whenReady().then(() => {
    ...
    ipcMain.handle('openExternal', (_, ...args: Parameters<OpenExternal>) => openExternal(...args));
